...
export const Main = () => {
    ...
    return (
        <div className="main-wrapper">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="130" height="130" viewBox="0 0 256 256" fill="none">
                <defs>
                    <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#16bcc8" />
                        <stop offset="100%" stop-color="#9016c8" />
                    </linearGradient>
                ...
                <g clip-path="url(#clip0_123_378)">
                    <path fill="url(#grad2)" fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div className="title-wrapper">
                    <div className='title'>
                        ...
                        <span className='titlespan'>Frontend</span>
                        </animated.div>
                        <animated.div style={animatedProps2}>
                        <span>development</span> 
                        </animated.div>
                        <animated.div style={animatedProps3}>
                        <span className='name'>by<span className='spanname'>NikitaFreeze</span></span>
                        </animated.div>
                    </div>
                </div>
            ...
            <div className="section2" ref={sect1}>
                <div className={!isVisible ? 'titlesect2' : 'titlesect2 visible2'}>Проекты</div>
                <div className="windowWrap">
                    <div className="window">
                        <img className={!isVisible ? 'imgwind' : 'imgwind visible'} src='/img1.png' />
                        <img className={!isVisible ? 'imgwind' : 'imgwind visible'} src='/img2.png' />
                        <img className={!isVisible ? 'imgwind' : 'imgwind visible'} src='/img3.png' />
                        <img className={!isVisible ? 'imgwind' : 'imgwind visible'} src='/img4.png' />
